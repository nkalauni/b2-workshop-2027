...
def build_theme():
    ...
    <div class="wrap wrap--narrow">
      ...
      <div class="note" style="margin-top:2.25rem">
        <strong>Still to come.</strong> The text above is drawn from the workshop invitation.
        A fuller statement of the symposium theme is in preparation and will be published here.
      </div>
    </div>
  </section>
